         ...
         if($image_size_01 > 2000000 OR $image_size_02 > 2000000 OR $image_size_03 > 2000000){
             ...
             if(move_uploaded_file($image_tmp_name_01, $image_folder_01) &&
                ...
                move_uploaded_file($image_tmp_name_03, $image_folder_03)) {
                 ...
                 $message[] = 'Failed to move one or more images to the destination folder.';
             }
         }
     }
      ...
      <div class="flex">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box" maxlength="100" placeholder="enter product category" name="category">
         </div>
      </div>
